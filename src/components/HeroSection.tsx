...
const HeroSection = () => {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden grid-bg">
      ...
      <div className="absolute bottom-1/4 right-1/4 w-72 h-72 bg-secondary/8 rounded-full blur-[100px] animate-glow-pulse" style={{ animationDelay: "1.5s" }} />
      ...
      <div className="container relative z-10 mx-auto px-6 text-center pt-20">
        ...
        <p className="mt-6 text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed opacity-0 animate-fade-up" style={{ animationDelay: "0.3s" }}>
          Logexa Labs helps startups and businesses build scalable software, AI-powered solutions, and high-performance web applications.
        </p>
